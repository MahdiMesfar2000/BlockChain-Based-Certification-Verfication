...
const testNetworks = [
    ...
    { network: dto_1.Network.HORIZEN_EON, expected: { chainId: 7332 } },
    ...
    { network: dto_1.Network.ETHEREUM_GOERLI, expected: { chainId: 5 }, apiKey: process.env.V3_API_KEY_TESTNET },
    { network: dto_1.Network.FANTOM, expected: { chainId: 250 }, apiKey: process.env.V3_API_KEY_MAINNET },
    { network: dto_1.Network.FANTOM_TESTNET, expected: { chainId: 4002 }, apiKey: process.env.V3_API_KEY_TESTNET },
