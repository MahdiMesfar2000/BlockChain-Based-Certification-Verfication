...
const getAlgorandIndexerRpc = async (testnet) => await service_1.TatumSDK.init({
    network: testnet ? service_1.Network.ALGORAND_INDEXER_TESTNET : service_1.Network.ALGORAND_INDEXER,
    apiKey: {
