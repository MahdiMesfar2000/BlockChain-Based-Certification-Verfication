...
let SolanaLoadBalancerRpc = class SolanaLoadBalancerRpc extends AbstractSolanaRpc_1.AbstractSolanaRpc {
    constructor(id) {
        super();
...
exports.SolanaLoadBalancerRpc = SolanaLoadBalancerRpc = __decorate([
    (0, typedi_1.Service)({
        factory: (data) => {
...
//# sourceMappingURL=SolanaLoadBalancerRpc.js.map