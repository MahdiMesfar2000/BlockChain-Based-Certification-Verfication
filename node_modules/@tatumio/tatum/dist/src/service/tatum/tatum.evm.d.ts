...
export declare abstract class FaucetEvm extends BaseEvm {
    faucet: Faucet;
    constructor(id: string);
}
...
export declare class AvalancheC extends BaseEvm {
}
export declare class Cronos extends BaseEvm {
}
export declare class EthereumClassic extends BaseEvm {
}
export declare class Fantom extends BaseEvm {
}
export declare class Gnosis extends BaseEvm {
}
export declare class Haqq extends BaseEvm {
}
export declare class Flare extends BaseEvm {
}
...
export declare class Optimism extends BaseEvm {
}
...
export declare class HorizenEon extends FaucetEvm {
    address: Address;
    constructor(id: string);
}
